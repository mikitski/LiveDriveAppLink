...
//        }, 60 * 60, SECONDS);
    ...
    private void addCommands() {
 		...
 		leadNormalMeChoice.setVrCommands(new Vector<String>(Arrays.asList("Me")));
 		...
 		leadNormalFriend1Choice.setVrCommands(new Vector<String>(Arrays.asList("CaDanceMom1974")));
 		...
 		leadNormalFriend2Choice.setVrCommands(new Vector<String>(Arrays.asList("TwistTurny44")));
 		...
 		leadNormalFriend3Choice.setVrCommands(new Vector<String>(Arrays.asList("KevinMevinLevin")));
 		...
 		leadRacelFriend1Choice.setVrCommands(new Vector<String>(Arrays.asList("CaDanceMom1974")));
 		...
 		leadRaceFriend2Choice.setVrCommands(new Vector<String>(Arrays.asList("TwistTurny44")));
 		...
 		leadRaceFriend3Choice.setVrCommands(new Vector<String>(Arrays.asList("KevinMevinLevin")));
 		
 		
 		try{
 			proxy.createInteractionChoiceSet(new Vector<Choice>(Arrays.asList(leadNormalMeChoice, leadNormalFriend1Choice, leadNormalFriend2Choice, leadNormalFriend3Choice)), NORMAL_LEAD_CHOICESET, autoIncCorrId++);
 			proxy.createInteractionChoiceSet(new Vector<Choice>(Arrays.asList(leadRaceMeChoice, leadRacelFriend1Choice, leadRaceFriend2Choice, leadRaceFriend3Choice)), RACING_LEAD_CHOICESET, autoIncCorrId++);
 		}
 		catch(SyncException e)
 		{
 			Log.e("SyncException", e.getMessage());
...
//				display = DriverScoreService.getLeaderboard();
	...
	public void onOnVehicleData(OnVehicleData vehicleData) {
    	...
    	{
    		if(vehicleData.getPrndl() == PRNDL.PARK && prevVehicleData.getPrndl() != PRNDL.PARK)
	...
	public void onSubscribeVehicleDataResponse(SubscribeVehicleDataResponse response) {
		Log.i("SubscribeVehicleData", response.getResultCode().toString() + " - " + response.getInfo());
	}
	...
	public void onGetVehicleDataResponse(GetVehicleDataResponse response) {
		...
		Log.i("GetVehicleData", response.getResultCode().toString() + " - " + response.getInfo());
	}
